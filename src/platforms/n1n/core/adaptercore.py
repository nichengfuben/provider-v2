...
包含 N1nAdapter 类的完整实现，从原 adapter.py 提取。
"""
...
from .client import N1nClient
from .constants import CAPS, FETCH_MODELS_ENABLED, MODEL_FETCH_INTERVAL
