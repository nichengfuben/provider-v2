...
class AzureTranslateAdapter(PlatformAdapter):
    """Azure Translator 翻译平台适配器。"""
    ...
    async def init(self, session: aiohttp.ClientSession) -> None:
        ...
        """
        from .client import AzureTranslateClient  # noqa: PLC0415

        self._client = AzureTranslateClient()
    ...
    async def complete(
        ...
        **kw: Any,
        ...
        """翻译补全——提取文本，调用 Azure Translator API，返回翻译结果。"""
