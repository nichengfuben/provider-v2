...
class YandexTranslateAdapter(PlatformAdapter):
    """Yandex Translate 翻译平台适配器。"""
    ...
    async def init(self, session: aiohttp.ClientSession) -> None:
        ...
        """
        from .client import YandexTranslateClient  # noqa: PLC0415

        self._client = YandexTranslateClient()
    ...
    async def complete(
        ...
        **kw: Any,
        ...
        """翻译补全——提取文本，调用 Yandex Translate API，返回翻译结果。"""
