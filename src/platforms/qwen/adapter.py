...
class QwenAdapter:
    def __init__(self, session: aiohttp.ClientSession) -> None:
        ...
        self._api_base = _QWEN_API_BASE

    async def chat(self, messages: List[Dict[str, Any]], model: str = "qwen-turbo",
    ...
    async def chat_stream(self, messages: List[Dict[str, Any]], model: str = "qwen-turbo",
    ...
    def _get_auth(self) -> str:
        import os
        return f"Bearer {os.environ.get('QWEN_API_KEY', '')}"
